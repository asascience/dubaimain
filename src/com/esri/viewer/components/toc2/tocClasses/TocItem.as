...
public class TocItem extends EventDispatcher
{
	...
	internal static const DEFAULT_NODATA:Boolean = false;
	
	private var _nodata:Boolean = false;
	 ...
	 * @private
	 */
	public function set nodata(value:Boolean):void
	{
		var oldValue:Object = _nodata;
		_nodata = (value ? value : false);
		
		// Dispatch a property change event to notify the item renderer
		dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "nodata", oldValue, _nodata));
	}
