...
{	
	...
	private var _nodataLayers:ArrayCollection;
	...
	[Bindable("nodataLayersChanged")]
	/**
	 * A list of layer objects and/or layer IDs to include in the TOC.
	 */
	public function get nodataLayers():Object
	{
		return _nodataLayers;
	}
	
	/**
	 * @private
	 */
	public function set nodataLayers(value:Object):void
	{
		/*removeLayerFilterListeners(_nodataLayers);
		_nodataLayers = normalizeLayerFilter(value);
		addLayerFilterListeners(_nodataLayers);
		onFilterChange();
		dispatchEvent(new Event("nodataLayersChanged"));*/
	}
