...
package com.esri.viewer.components.toc.tocClasses
{
	...
	import com.esri.viewer.components.toc.controls.CheckBoxScaleDependant;
	...
	public class TocItemRenderer extends TreeItemRenderer
	{
		...
		// Is checkbox inermediate before checkbox mousedown
		private var cbInter:Boolean;
		...
		override protected function commitProperties():void
		{
			...
			if (data is TocItem) {
				...
				// The scaledependant state has visual priority over the selected state
				_checkbox.selected = item.visible //&& !item.scaledependant;
