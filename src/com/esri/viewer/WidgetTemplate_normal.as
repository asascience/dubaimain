...
public class WidgetTemplate_normal extends SkinnableContainer implements IWidgetTemplate
{
    ...
    public function WidgetTemplate_normal()
    {
        super();
    ...
    public function addTitlebarButton(btnIcon:String, btnTip:String, btnFunction:Function, selectable:Boolean = true,buttonText:Boolean = false,buttonString:String= ""):void
    {
        if(buttonText == true)
		{
			var btnText:Button = new Button();
			btnText.callLater(btnFunction);
			btnText.enabled = selectable;
			btnText.label = buttonString;
			btnText.toolTip = btnTip;
			btnText.setStyle("fontSize",10);
			if (selectable)
			{
