...
public class BaseWidget extends Module implements IBaseWidget
{
	...
	private var _isDockable:Boolean = true;
	...
	public function get isDockable():Boolean
	{
		return _isDockable;
	}
    ...
    private function initWidgetTemplate(event:Event):void
    {
        ...
        for each (var child:Object in children)
        {
            if (child is IWidgetTemplate)
            {
                ...
                if (_widgetPreload == WIDGET_MINIMIZED)
                {
                    _widgetTemplate.widgetState = WIDGET_MINIMIZED;
                }
            }
        }
