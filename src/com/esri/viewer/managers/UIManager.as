...
public class UIManager extends EventDispatcher
{
    ...
    private function setViewerStyle():void
    {
        ...
        */
		...
		cssStyleDeclarationInfoContainer.setStyle("infoOffsetY",50);
       ...
       /* if (numberOfStyleColors > 4)
        ...
        if (numberOfStyleColors > 4)
        {
			...
			cssStyleDeclarationNavigator.setStyle("chromeColor", backgroundColor);
        }
        ...
        if (numberOfStyleColors > 4)
        {
            ...
            //cssStyleDeclarationTitleWindow.setStyle("backgroundColor", 0x64b1cb);
			cssStyleDeclarationTitleWindow.setStyle("chromeColor", 0x3d9bbf);
			//cssStyleDeclarationTitleWindow.setStyle("contentBackgroundColor", 0x64b1cb);
			cssStyleDeclarationTitleWindow.setStyle("symbolColor", backgroundColor);
			//cssStyleDeclarationTitleWindow.setStyle("selectionColor", 0x64b1cb);
			//cssStyleDeclarationTitleWindow.setStyle("focusColor", 0x64b1cb);
			//cssStyleDeclarationTitleWindow.setStyle("accentColor", F9F9FB);
