package widgets.OilSpill.components.wms
{
	...
	public class WMSModelold extends DynamicMapServiceLayer
	{
		...
		public function WMSModelold(wmsURL:String, oilID:String, path:String, timeSpill:String, part1:Boolean, part2:Boolean, part3:Boolean, part4:Boolean, part5:Boolean, key:String)
		{			
			var styles1:String;
