...
package widgets.OilSpill.components.dougmccune.baseClasses
{
...
import widgets.OilSpill.components.dougmccune.controls.sliderClasses.SliderThumb;
    ...
    */
    ...
    override protected function createChildren():void
    {
        ...
        dataFormatter = new NumberBase(
            resourceManager.getString('SharedResources', 'decimalSeparatorFrom'), 
            resourceManager.getString('SharedResources', 'thousandsSeparatorFrom'),
            resourceManager.getString('SharedResources', 'decimalSeparatorTo'), "");
