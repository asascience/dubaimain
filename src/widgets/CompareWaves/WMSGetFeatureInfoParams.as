package widgets.Identify_Dubai
{
	import widgets.Identify_Dubai.IHttpParams;
	...
	public class WMSGetFeatureInfoParams extends OGCParams
	{
		...
		public function WMSGetFeatureInfoParams(layers:String, srs:String, format:String = "text/xml", styles:String = null)
		{
			super("WMS", srs, "1.1.1", "GetFeatureInfo");
